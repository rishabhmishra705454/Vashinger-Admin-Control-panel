...
public class IronControlAdapter extends RecyclerView.Adapter<IronControlAdapter.ViewHolder>{
    ...
    public IronControlAdapter(Context context, ArrayList<DryCleaningControlModal> addDetailModelArrayList) {
