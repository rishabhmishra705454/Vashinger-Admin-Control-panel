...
import com.vashinger.admin.databinding.FragmentDryCleaningControlBinding;
import com.vashinger.admin.modal.DryCleaningControlModal;

import java.util.ArrayList;
import java.util.List;

public class DryCleaningControlFragment extends Fragment {

    private FragmentDryCleaningControlBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDryCleaningControlBinding.inflate(getLayoutInflater(), container, false);
