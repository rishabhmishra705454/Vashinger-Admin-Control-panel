...
public class WashAndIronFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRef.child("washAndIronSetting").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        binding.saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myRef.child("washAndIronSetting").updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
